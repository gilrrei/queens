...
def plot_pdf(pdf_estimate: dict, support_points: np.ndarray, bayes: bool = False):
...
def plot_cdf(cdf_estimate: dict, support_points: np.ndarray, bayes: bool = False):
...
def plot_icdf(icdf_estimate: dict, bayes: bool = False):
