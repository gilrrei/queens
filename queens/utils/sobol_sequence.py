...
def sample_sobol_sequence(
    ...
    Args:
        ...
        parameters: parameters object defined the true distribution of the samples
        randomize: If True, use LMS+shift scrambling, i.e. randomize the sequence.
                                    Otherwise, no scrambling is done. Default is False.
        seed: If `seed` is an int or None, a new `numpy.random.Generator`
