...
def mh_select(
    ...
    Args:
        log_acceptance_probability: Logarithm of the acceptance probability for each
    ...
    Returns:
        The sample values selected after the Metropolis-Hastings
                                     step. If the proposed sample is accepted, it will be returned;
                                     otherwise, the current sample is returned.
        A boolean array indicating whether each proposed sample was accepted
...
def tune_scale_covariance(
    ...
    Args:
        scale_covariance: The current covariance scaling factor for the proposal
        distribution.
        accept_rate: The observed acceptance rate of the proposed samples. This
